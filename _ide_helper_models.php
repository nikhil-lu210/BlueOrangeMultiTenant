 ...
 * @property int $id
 * @property string $name
 * @property string $super_admin_name
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Tenant whereSuperAdminName($value)
...
namespace App\Models\Tenant{
/**
 * App\Models\Tenant\TenantRequest
 *
 * @property int $id
 * @property string $name
 * @property string $super_admin_name
 ...
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder|TenantRequest newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|TenantRequest newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|TenantRequest query()
 * @method static \Illuminate\Database\Eloquent\Builder|TenantRequest whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|TenantRequest whereEmail($value)
 * @method static \Illuminate\Database\Eloquent\Builder|TenantRequest whereEmailVerifiedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|TenantRequest whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|TenantRequest whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|TenantRequest wherePassword($value)
 * @method static \Illuminate\Database\Eloquent\Builder|TenantRequest whereSuperAdminName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|TenantRequest whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|TenantRequest whereVerificationToken($value)
 */
	class TenantRequest extends \Eloquent {}
}
