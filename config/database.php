...
return [
    ...
    */
    ...
    'default' => env('DB_CONNECTION_LANDLORD', 'mysql'),
    ...
    */
    ...
    'connections' => [
        ...
        'mysql_landlord' => [
            ...
            'database' => env('DB_DATABASE_LANDLORD', 'tenancy_landlord'), // This is for the landlord database
        ...
        'mysql_tenant' => [
            ...
            'database' => null,  // This will be dynamically set based on tenant
